...
const styles = StyleSheet.create({
  ...
  // Header + tabs
  headerWrap: { backgroundColor: '#4F46E5', paddingHorizontal: 20, paddingBottom: 0 },
  headerTitulo: { fontSize: 22, fontWeight: '700', color: '#FFFFFF', paddingVertical: 16 },
  tabs: { flexDirection: 'row', gap: 4, paddingBottom: 12 },
  tab: {
    flex: 1, paddingVertical: 8, borderRadius: 10, alignItems: 'center',
    backgroundColor: 'rgba(255,255,255,0.15)',
  },
  tabAtiva: { backgroundColor: '#FFFFFF' },
  tabTexto: { fontSize: 14, fontWeight: '600', color: 'rgba(255,255,255,0.75)' },
  tabTextoAtivo: { color: '#4F46E5' },
  ...
  tipoChip: { backgroundColor: '#F3F4F6', paddingHorizontal: 7, paddingVertical: 3, borderRadius: 20 },
  ...
  cardTitulo: { fontSize: 16, fontWeight: '600', color: '#111827', marginBottom: 12, lineHeight: 22 },
  ...
  histMetricaValor: { fontSize: 15, fontWeight: '700', color: '#111827' },
  histMetricaLabel: { fontSize: 10, color: '#9CA3AF', marginTop: 2 },
  histMetricaSep: { width: 1, height: 32, backgroundColor: '#E5E7EB' },

  centrado: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 32, backgroundColor: '#F3F4F6' },
  carregandoTexto: { marginTop: 12, fontSize: 14, color: '#6B7280' },
  erroTexto: { fontSize: 14, color: '#374151', textAlign: 'center', marginTop: 12, lineHeight: 20 },
  botaoTentar: { marginTop: 20, backgroundColor: '#4F46E5', borderRadius: 12, paddingHorizontal: 24, paddingVertical: 12 },
  botaoTentarTexto: { color: '#fff', fontWeight: '600', fontSize: 15 },
  vazio: { alignItems: 'center', padding: 32 },
  vazioTitulo: { fontSize: 16, fontWeight: '600', color: '#374151', marginTop: 16, textAlign: 'center' },
  vazioSub: { fontSize: 13, color: '#9CA3AF', textAlign: 'center', marginTop: 8, lineHeight: 18 },
});
