...
const CONQUISTAS = [
  { id: 1, icon: 'rocket-outline',       bg: '#7C3AED', label: 'Primeiro\nSimulado',  date: '10/01/2024', locked: false },
  { id: 2, icon: 'calculator-outline',   bg: '#059669', label: 'Nota\nPerfeita',      date: '25/01/2024', locked: false },
  { id: 3, icon: 'trophy-outline',       bg: '#D97706', label: 'Foco no\nObjetivo',   date: '05/02/2024', locked: false },
  { id: 4, icon: 'star-outline',         bg: '#2563EB', label: 'Dedicação\nTotal',    date: '20/02/2024', locked: false },
  { id: 5, icon: 'lock-closed-outline',  bg: '#9CA3AF', label: 'Em breve',            date: '',           locked: true  },
];
      ...
      <View style={styles.card}>
        ...
        <View style={styles.acertosErros}>
          <View style={styles.aeItem}>
            ...
            <Text style={[styles.aeValor, { color: '#059669' }]}>213</Text>
            <View style={[styles.progressBar, { backgroundColor: '#D1FAE5' }]}>
              <View style={[styles.progressFill, { width: '87%', backgroundColor: '#10B981' }]} />
            </View>
          </View>
          <View style={styles.aeItem}>
            <Text style={styles.aeLabel}>Erros</Text>
            <Text style={[styles.aeValor, { color: '#7C3AED' }]}>17</Text>
            <View style={[styles.progressBar, { backgroundColor: '#EDE9FE' }]}>
              <View style={[styles.progressFill, { width: '13%', backgroundColor: '#7C3AED' }]} />
            </View>
          </View>
        </View>

        <View style={styles.insightBox}>
          <Ionicons name="bulb-outline" size={17} color="#7C3AED" style={{ marginRight: 8, flexShrink: 0 }} />
          <Text style={styles.insightTexto}>
            Você está indo muito bem! Seu desempenho está{' '}
            <Text style={{ color: '#7C3AED', fontWeight: '600' }}>15% acima</Text>
            {' '}da média da turma.
          </Text>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.hScroll}>
            {simuladosRecentes.length === 0 ? (
              ...
              return (
                ...
                >
                  {/* Ícone + matéria */}
                  <View style={[styles.simIconWrap, { backgroundColor: (s.subject?.color ?? cor) + '1A' }]}>
                    <Ionicons
                      name={subjectIconName(s.subject?.icon ?? '') as any}
                      size={24}
                      color={s.subject?.color ?? cor}
                    />
                  </View>
                  {s.subject && (
                    <Text style={[styles.simMateria, { color: s.subject.color }]}>
                      {s.subject.name}
                    </Text>
                  )}
                  ...
                  <View style={styles.simRodape}>
                    ...
                    <Text style={[styles.simLink, { color: cor }]}>Abrir →</Text>
                  </View>
                </TouchableOpacity>
              );
            })}
...
const styles = StyleSheet.create({
  ...
  headerIcons: { flexDirection: 'row', justifyContent: 'flex-end', gap: 8, marginBottom: 20 },
  ...
  avatarInitials: { fontSize: 28, fontWeight: '700', color: '#7C3AED' },
  avatarEditBtn:  {
  ...
  userInfo:   { flex: 1 },
  userName:   { fontSize: 22, fontWeight: '700', color: '#111827', marginBottom: 2 },
  ...
  statsRow:  { flexDirection: 'row', borderTopWidth: 1, borderTopColor: '#F3F4F6', paddingTop: 16 },
  ...
  // Simulados
  simCard: {
    width: 168, minHeight: 180, backgroundColor: '#fff', borderRadius: 18, padding: 16,
  ...
  simMateria: { fontSize: 11, fontWeight: '700', marginBottom: 8, letterSpacing: 0.2 },
  ...
  simLink:    { fontSize: 12, fontWeight: '700' },
  ...
  metaInfo:     { flex: 1 },
  metaSubtitulo:{ fontSize: 11, color: '#7C3AED', fontWeight: '600', marginBottom: 2 },
  metaTitulo:   { fontSize: 14, fontWeight: '700', color: '#111827', marginBottom: 8 },
  metaBar:      { height: 6, backgroundColor: '#EDE9FE', borderRadius: 3, overflow: 'hidden', marginBottom: 4 },
  metaBarFill:  { height: '100%', backgroundColor: '#7C3AED', borderRadius: 3 },
  metaNumeros:  { fontSize: 11, color: '#9CA3AF' },
  metaPct:      { fontSize: 14, fontWeight: '700', color: '#7C3AED' },
  ...
  conquEmBreve:{ fontSize: 10, color: '#7C3AED', fontWeight: '600', textAlign: 'center', marginTop: 2 },
  ...
  botaoSalvar:     { backgroundColor: '#4F46E5', borderRadius: 10, paddingVertical: 12, alignItems: 'center', marginTop: 8 },
