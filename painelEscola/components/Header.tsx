...
export default function Header() {
  ...
  return (
    <View
      className="h-16 bg-white border-b border-gray-100 flex-row items-center px-6"
    ...
    >
      ...
      {/* Notificações */}
      <TouchableOpacity
        className="w-10 h-10 items-center justify-center rounded-full bg-gray-50 border border-gray-200 mr-5"
        activeOpacity={0.7}
      >
      ...
      <TouchableOpacity
        onPress={logout}
        className="w-10 h-10 items-center justify-center rounded-full bg-red-50 border border-red-100 ml-3"
        activeOpacity={0.7}
      >
