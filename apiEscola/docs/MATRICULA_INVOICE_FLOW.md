...
- `provider_boleto_list` lista boletos **desta matrícula** (inclui `cora_charge_id` já vinculado local) ou **mesmo CPF** do pagador; outros CPFs da escola não aparecem. Status Cora `LATE` exibido como **Atrasada**.
